...
CREATE TABLE "new_UserCounter" (
    ...
    "cumulativeCompletedTasks" INTEGER NOT NULL DEFAULT 0,
...
INSERT INTO "new_UserCounter" ("balance", "canWithdraw", "completedTasks", "counterId", "createdAt", "dailyCompletedOrders", "id", "isActive", "lastActivityDate", "lastOrderResetDate", "totalEarnings", "updatedAt", "userId") SELECT "balance", "canWithdraw", "completedTasks", "counterId", "createdAt", "dailyCompletedOrders", "id", "isActive", "lastActivityDate", "lastOrderResetDate", "totalEarnings", "updatedAt", "userId" FROM "UserCounter";
